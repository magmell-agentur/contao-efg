 ...
 * 
 * Author: oleslie
 * http://sourceforge.net/projects/xls-exportclass/
 * License: GPL
 * Release: 080531
 */
	...
	class xlsexport {
		...
		public function __construct() {
			...
			// ### 2008-11-29 added by Thomas Kuhn: for TYPOlight
			$this->temp_dir = TL_ROOT . '/system/tmp/';
...
*/
	...
	public function sendfile($afilename) {
		// ### 2008-11-29 changed by Thomas Kuhn: for TYPOlight
		//$tmpname = "tmp".date("YmdHi").".xls";
		$tmpname = $this->temp_dir . "tmp_xls_".date("YmdHis").".xls";
