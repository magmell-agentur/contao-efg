...
$GLOBALS['TL_LANG']['tl_form']['useFormValues'] = array('Export field values', 'If you choose this option, during export field values will be exported instead of field identifiers for the selected form fields. This applies to form field types select menu, radio button menu and checkbox menu. This option does not affect fied types select menu (DB), radio button menu (DB) and checkbox menu (DB).');
