...
$GLOBALS['TL_LANG']['tl_formdata']['import_preview'] = array('Preview and field mapping', 'Please select the form data fields in which the columns of the CSV file should be imported. The table below shows up to 10 lines of the CSV file.');
