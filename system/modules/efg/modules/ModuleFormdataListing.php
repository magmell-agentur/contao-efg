...
class ModuleFormdataListing extends \Module
{
	...
	protected function compile()
	{
		...
		else
		{
			...
			$this->Template->iconFolder = (strlen($this->efg_iconfolder) ? $this->efg_iconfolder : 'system/modules/efg/public');
						...
						elseif (is_string($value) && strlen($value) && is_file(TL_ROOT . '/' . $value))
						{
							...
							else
							{
								...
								else
								{
									...
									$arrTd[$class][count($arrTd[$class])-1]['icon'] = (strlen($this->efg_iconfolder)? $this->efg_iconfolder.'/' : 'system/modules/efg/public/') . $objFile->icon;
									...
									$arrListItems[$i][$k]['icon'] = (strlen($this->efg_iconfolder)? $this->efg_iconfolder.'/' : 'system/modules/efg/public/') . $objFile->icon;
								}
							}
						}
						// multiple files
